...
export async function POST(request: NextRequest) {
  try {
    ...
    const storagePath = `${year}/${month}/${proposalId}/${category}/${timestamp}_${randomStr}.${fileExt}`
    ...
    // Get public URL (tetap private, tapi generate signed URL nanti)
    ...
    const { data: docData, error: docError } = await supabaseAdmin
      ...
      .insert({
        ...
        url: publicUrl,
        category: category,
        uploaded_by: null, // NULL untuk public submission
        version: 1,
        is_current: true,
      })
      .select()
